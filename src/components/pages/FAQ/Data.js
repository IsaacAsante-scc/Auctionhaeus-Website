export const FaqObjOne = {
    lightBg: false,
    lightText: true,
    lightTextDesc: true,
    topLine: 'Weekly Auctions',
    headline: 'Headline for auction goes here',
...
export const FaqData = [
    ...
    {
        question: 'What Payment Methods Are Avaliable?',
        answer: '‣ Payment methods include online payment (only debit, VISA/Mastercard), electronic money transfer (etransfer) or Cash. Debit/credit machine is available for in person pickups. All purchases are in Canadian dollars (CAD$) and are subject to a 16.5% buyers premium and 13% HST. PLEASE NOTE: Online payment or in store purchases by debit or credit card is subject to a 3% processing fee.'
    },
    {
        question: 'How Do I Schedule A Pick-Up Timeslot?',
        answer: '‣ When the Auction closes a purchase invoice and pick-up details will be sent by e-mail and a pick-up timeslot can be scheduled by the customer through our online scheduling software.'
    },
